namespace Octokit
{
    ...
    public class Query : QueryableValue<Query>, IQuery
    {
        ...
        public CodeOfConduct CodeOfConduct(Arg<string> key) => this.CreateMethodCall(x => x.CodeOfConduct(key), Octokit.Model.CodeOfConduct.Create);
        ...
        public Enterprise Enterprise(Arg<string> slug, Arg<string>? invitationToken = null) => this.CreateMethodCall(x => x.Enterprise(slug, invitationToken), Octokit.Model.Enterprise.Create);
        ...
        public EnterpriseAdministratorInvitation EnterpriseAdministratorInvitation(Arg<string> enterpriseSlug, Arg<EnterpriseAdministratorRole> role, Arg<string> userLogin) => this.CreateMethodCall(x => x.EnterpriseAdministratorInvitation(enterpriseSlug, role, userLogin), Octokit.Model.EnterpriseAdministratorInvitation.Create);

        /// <summary>
        /// Look up a pending enterprise administrator invitation by invitation token.
        /// </summary>
        /// <param name="invitationToken">The invitation token sent with the invitation email.</param>
        public EnterpriseAdministratorInvitation EnterpriseAdministratorInvitationByToken(Arg<string> invitationToken) => this.CreateMethodCall(x => x.EnterpriseAdministratorInvitationByToken(invitationToken), Octokit.Model.EnterpriseAdministratorInvitation.Create);

        /// <summary>
        /// Look up an open source license by its key
        /// </summary>
        /// <param name="key">The license's downcased SPDX ID</param>
        public License License(Arg<string> key) => this.CreateMethodCall(x => x.License(key), Octokit.Model.License.Create);
        ...
        public MarketplaceCategory MarketplaceCategory(Arg<string> slug, Arg<bool>? useTopicAliases = null) => this.CreateMethodCall(x => x.MarketplaceCategory(slug, useTopicAliases), Octokit.Model.MarketplaceCategory.Create);
        ...
        public MarketplaceListing MarketplaceListing(Arg<string> slug) => this.CreateMethodCall(x => x.MarketplaceListing(slug), Octokit.Model.MarketplaceListing.Create);
        ...
        public RateLimit RateLimit(Arg<bool>? dryRun = null) => this.CreateMethodCall(x => x.RateLimit(dryRun), Octokit.Model.RateLimit.Create);
        ...
        /// </summary>
        public Query Relay => this.CreateProperty(x => x.Relay, Octokit.Query.Create);
        ...
        public Repository Repository(Arg<string> name, Arg<string> owner, Arg<bool>? followRenames = null) => this.CreateMethodCall(x => x.Repository(name, owner, followRenames), Octokit.Model.Repository.Create);

        /// <summary>
        /// Lookup a repository owner (ie. either a User or an Organization) by login.
        /// </summary>
        /// <param name="login">The username to lookup the owner by.</param>
        public IRepositoryOwner RepositoryOwner(Arg<string> login) => this.CreateMethodCall(x => x.RepositoryOwner(login), Octokit.Model.Internal.StubIRepositoryOwner.Create);

        /// <summary>
        /// Lookup resource by a URL.
        /// </summary>
        /// <param name="url">The URL.</param>
        public IUniformResourceLocatable Resource(Arg<string> url) => this.CreateMethodCall(x => x.Resource(url), Octokit.Model.Internal.StubIUniformResourceLocatable.Create);
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public SearchResultItemConnection Search(Arg<string> query, Arg<SearchType> type, Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.Search(query, type, first, after, last, before), Octokit.Model.SearchResultItemConnection.Create);
        ...
        public SponsorableItemConnection Sponsorables(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<SecurityAdvisoryEcosystem>? dependencyEcosystem = null, Arg<DependencyGraphEcosystem>? ecosystem = null, Arg<bool>? onlyDependencies = null, Arg<SponsorableOrder>? orderBy = null, Arg<string>? orgLoginForDependencies = null) => this.CreateMethodCall(x => x.Sponsorables(first, after, last, before, dependencyEcosystem, ecosystem, onlyDependencies, orderBy, orgLoginForDependencies), Octokit.Model.SponsorableItemConnection.Create);

        /// <summary>
        /// Look up a topic by name.
        /// </summary>
        /// <param name="name">The topic's name.</param>
        public Topic Topic(Arg<string> name) => this.CreateMethodCall(x => x.Topic(name), Octokit.Model.Topic.Create);

        /// <summary>
        /// Lookup a user by login.
        /// </summary>
        /// <param name="login">The user's login.</param>
        public User User(Arg<string> login) => this.CreateMethodCall(x => x.User(login), Octokit.Model.User.Create);

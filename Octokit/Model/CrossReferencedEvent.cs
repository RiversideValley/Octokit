namespace Octokit.Model
{
    ...
    public class CrossReferencedEvent : QueryableValue<CrossReferencedEvent>
    {
        ...
        /// </summary>
        public ReferencedSubject Source => this.CreateProperty(x => x.Source, Octokit.Model.ReferencedSubject.Create);

        /// <summary>
        /// Issue or pull request to which the reference was made.
        /// </summary>
        public ReferencedSubject Target => this.CreateProperty(x => x.Target, Octokit.Model.ReferencedSubject.Create);

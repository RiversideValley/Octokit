namespace Octokit.Model
{
    ...
    public class RemovedFromMergeQueueEvent : QueryableValue<RemovedFromMergeQueueEvent>
    {
        ...
        /// </summary>
        public Commit BeforeCommit => this.CreateProperty(x => x.BeforeCommit, Octokit.Model.Commit.Create);
        ...
        /// </summary>
        public User Enqueuer => this.CreateProperty(x => x.Enqueuer, Octokit.Model.User.Create);

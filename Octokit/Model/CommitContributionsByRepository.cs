namespace Octokit.Model
{
    ...
    public class CommitContributionsByRepository : QueryableValue<CommitContributionsByRepository>
    {
        ...
        public CreatedCommitContributionConnection Contributions(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<CommitContributionOrder>? orderBy = null) => this.CreateMethodCall(x => x.Contributions(first, after, last, before, orderBy), Octokit.Model.CreatedCommitContributionConnection.Create);

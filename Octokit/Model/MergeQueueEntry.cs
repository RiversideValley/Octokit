namespace Octokit.Model
{
    ...
    public class MergeQueueEntry : QueryableValue<MergeQueueEntry>
    {
        ...
        /// </summary>
        public Commit BaseCommit => this.CreateProperty(x => x.BaseCommit, Octokit.Model.Commit.Create);
        ...
        /// </summary>
        public IActor Enqueuer => this.CreateProperty(x => x.Enqueuer, Octokit.Model.Internal.StubIActor.Create);
        ...
        /// </summary>
        public Commit HeadCommit => this.CreateProperty(x => x.HeadCommit, Octokit.Model.Commit.Create);

namespace Octokit.Model
{
    ...
    public class ReviewDismissedEvent : QueryableValue<ReviewDismissedEvent>
    {
        ...
        /// </summary>
        public PullRequestCommit PullRequestCommit => this.CreateProperty(x => x.PullRequestCommit, Octokit.Model.PullRequestCommit.Create);
        ...
        /// </summary>
        public PullRequestReview Review => this.CreateProperty(x => x.Review, Octokit.Model.PullRequestReview.Create);

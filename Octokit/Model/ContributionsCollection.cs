namespace Octokit.Model
{
    ...
    public class ContributionsCollection : QueryableValue<ContributionsCollection>
    {
        ...
        /// </summary>
        public ContributionCalendar ContributionCalendar => this.CreateProperty(x => x.ContributionCalendar, Octokit.Model.ContributionCalendar.Create);
        ...
        /// </summary>
        public CreatedIssueOrRestrictedContribution FirstIssueContribution => this.CreateProperty(x => x.FirstIssueContribution, Octokit.Model.CreatedIssueOrRestrictedContribution.Create);

        /// <summary>
        /// The first pull request the user opened on GitHub. This will be null if that pull request was opened outside the collection's time range and ignoreTimeRange is not true. If the pull request is not visible but the user has opted to show private contributions, a RestrictedContribution will be returned.
        /// </summary>
        public CreatedPullRequestOrRestrictedContribution FirstPullRequestContribution => this.CreateProperty(x => x.FirstPullRequestContribution, Octokit.Model.CreatedPullRequestOrRestrictedContribution.Create);

        /// <summary>
        /// The first repository the user created on GitHub. This will be null if that first repository was created outside the collection's time range and ignoreTimeRange is false. If the repository is not visible, then a RestrictedContribution is returned.
        /// </summary>
        public CreatedRepositoryOrRestrictedContribution FirstRepositoryContribution => this.CreateProperty(x => x.FirstRepositoryContribution, Octokit.Model.CreatedRepositoryOrRestrictedContribution.Create);
        ...
        /// </summary>
        public JoinedGitHubContribution JoinedGitHubContribution => this.CreateProperty(x => x.JoinedGitHubContribution, Octokit.Model.JoinedGitHubContribution.Create);
        ...
        /// </summary>
        public ContributionsCollection MostRecentCollectionWithActivity => this.CreateProperty(x => x.MostRecentCollectionWithActivity, Octokit.Model.ContributionsCollection.Create);

        /// <summary>
        /// Returns a different contributions collection from an earlier time range than this one
        /// that does not have any contributions.
        /// </summary>
        public ContributionsCollection MostRecentCollectionWithoutActivity => this.CreateProperty(x => x.MostRecentCollectionWithoutActivity, Octokit.Model.ContributionsCollection.Create);

        /// <summary>
        /// The issue the user opened on GitHub that received the most comments in the specified
        /// time frame.
        /// </summary>
        public CreatedIssueContribution PopularIssueContribution => this.CreateProperty(x => x.PopularIssueContribution, Octokit.Model.CreatedIssueContribution.Create);

        /// <summary>
        /// The pull request the user opened on GitHub that received the most comments in the
        /// specified time frame.
        /// </summary>
        public CreatedPullRequestContribution PopularPullRequestContribution => this.CreateProperty(x => x.PopularPullRequestContribution, Octokit.Model.CreatedPullRequestContribution.Create);
        ...
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        /// <param name="orderBy">Ordering options for contributions returned from the connection.</param>
        public CreatedPullRequestReviewContributionConnection PullRequestReviewContributions(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<ContributionOrder>? orderBy = null) => this.CreateMethodCall(x => x.PullRequestReviewContributions(first, after, last, before, orderBy), Octokit.Model.CreatedPullRequestReviewContributionConnection.Create);

namespace Octokit.Model
{
    ...
    public class DiscussionPoll : QueryableValue<DiscussionPoll>
    {
        ...
        public DiscussionPollOptionConnection Options(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<DiscussionPollOptionOrder>? orderBy = null) => this.CreateMethodCall(x => x.Options(first, after, last, before, orderBy), Octokit.Model.DiscussionPollOptionConnection.Create);

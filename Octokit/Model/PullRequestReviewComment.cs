namespace Octokit.Model
{
    ...
    public class PullRequestReviewComment : QueryableValue<PullRequestReviewComment>
    {
        ...
        /// </summary>
        public Commit OriginalCommit => this.CreateProperty(x => x.OriginalCommit, Octokit.Model.Commit.Create);
        ...
        /// </summary>
        public PullRequestReview PullRequestReview => this.CreateProperty(x => x.PullRequestReview, Octokit.Model.PullRequestReview.Create);
        ...
        /// </summary>
        public PullRequestReviewComment ReplyTo => this.CreateProperty(x => x.ReplyTo, Octokit.Model.PullRequestReviewComment.Create);

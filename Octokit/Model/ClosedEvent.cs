namespace Octokit.Model
{
    ...
    public class ClosedEvent : QueryableValue<ClosedEvent>
    {
        ...
        /// </summary>
        public IClosable Closable => this.CreateProperty(x => x.Closable, Octokit.Model.Internal.StubIClosable.Create);

        /// <summary>
        /// Object which triggered the creation of this event.
        /// </summary>
        public Closer Closer => this.CreateProperty(x => x.Closer, Octokit.Model.Closer.Create);

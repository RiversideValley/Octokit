namespace Octokit.Model
{
    ...
    public class PullRequestReviewContributionsByRepository : QueryableValue<PullRequestReviewContributionsByRepository>
    {
        ...
        public CreatedPullRequestReviewContributionConnection Contributions(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<ContributionOrder>? orderBy = null) => this.CreateMethodCall(x => x.Contributions(first, after, last, before, orderBy), Octokit.Model.CreatedPullRequestReviewContributionConnection.Create);

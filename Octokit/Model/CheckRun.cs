namespace Octokit.Model
{
    ...
    public class CheckRun : QueryableValue<CheckRun>
    {
        ...
        public CheckAnnotationConnection Annotations(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.Annotations(first, after, last, before), Octokit.Model.CheckAnnotationConnection.Create);
        ...
        /// </summary>
        public DeploymentRequest PendingDeploymentRequest => this.CreateProperty(x => x.PendingDeploymentRequest, Octokit.Model.DeploymentRequest.Create);
        ...
        public CheckStepConnection Steps(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<int>? number = null) => this.CreateMethodCall(x => x.Steps(first, after, last, before, number), Octokit.Model.CheckStepConnection.Create);

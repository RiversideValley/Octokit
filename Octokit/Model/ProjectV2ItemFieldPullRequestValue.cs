namespace Octokit.Model
{
    ...
    public class ProjectV2ItemFieldPullRequestValue : QueryableValue<ProjectV2ItemFieldPullRequestValue>
    {
        ...
        public PullRequestConnection PullRequests(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<PullRequestOrder>? orderBy = null) => this.CreateMethodCall(x => x.PullRequests(first, after, last, before, orderBy), Octokit.Model.PullRequestConnection.Create);

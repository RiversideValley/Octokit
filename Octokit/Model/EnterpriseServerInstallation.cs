namespace Octokit.Model
{
    ...
    public class EnterpriseServerInstallation : QueryableValue<EnterpriseServerInstallation>
    {
        ...
        public EnterpriseServerUserAccountConnection UserAccounts(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<EnterpriseServerUserAccountOrder>? orderBy = null) => this.CreateMethodCall(x => x.UserAccounts(first, after, last, before, orderBy), Octokit.Model.EnterpriseServerUserAccountConnection.Create);

namespace Octokit.Model
{
    ...
    public class ProjectCard : QueryableValue<ProjectCard>
    {
        ...
        /// </summary>
        public ProjectColumn Column => this.CreateProperty(x => x.Column, Octokit.Model.ProjectColumn.Create);

        /// <summary>
        /// The card content item
        /// </summary>
        public ProjectCardItem Content => this.CreateProperty(x => x.Content, Octokit.Model.ProjectCardItem.Create);

namespace Octokit.Model
{
    ...
    public class AddPullRequestReviewCommentPayload : QueryableValue<AddPullRequestReviewCommentPayload>
    {
        ...
        /// </summary>
        public PullRequestReviewComment Comment => this.CreateProperty(x => x.Comment, Octokit.Model.PullRequestReviewComment.Create);

        /// <summary>
        /// The edge from the review's comment connection.
        /// </summary>
        public PullRequestReviewCommentEdge CommentEdge => this.CreateProperty(x => x.CommentEdge, Octokit.Model.PullRequestReviewCommentEdge.Create);

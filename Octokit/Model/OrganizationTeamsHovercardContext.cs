namespace Octokit.Model
{
    ...
    public class OrganizationTeamsHovercardContext : QueryableValue<OrganizationTeamsHovercardContext>
    {
        ...
        public TeamConnection RelevantTeams(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.RelevantTeams(first, after, last, before), Octokit.Model.TeamConnection.Create);

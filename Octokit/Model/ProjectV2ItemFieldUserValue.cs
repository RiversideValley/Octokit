namespace Octokit.Model
{
    ...
    public class ProjectV2ItemFieldUserValue : QueryableValue<ProjectV2ItemFieldUserValue>
    {
        ...
        public UserConnection Users(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.Users(first, after, last, before), Octokit.Model.UserConnection.Create);

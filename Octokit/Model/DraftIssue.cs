namespace Octokit.Model
{
    ...
    public class DraftIssue : QueryableValue<DraftIssue>
    {
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public ProjectV2ItemConnection ProjectV2Items(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.ProjectV2Items(first, after, last, before), Octokit.Model.ProjectV2ItemConnection.Create);
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public ProjectV2Connection ProjectsV2(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.ProjectsV2(first, after, last, before), Octokit.Model.ProjectV2Connection.Create);

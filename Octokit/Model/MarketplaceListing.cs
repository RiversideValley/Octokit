namespace Octokit.Model
{
    ...
    public class MarketplaceListing : QueryableValue<MarketplaceListing>
    {
        ...
        /// </summary>
        public MarketplaceCategory PrimaryCategory => this.CreateProperty(x => x.PrimaryCategory, Octokit.Model.MarketplaceCategory.Create);
        ...
        /// </summary>
        public MarketplaceCategory SecondaryCategory => this.CreateProperty(x => x.SecondaryCategory, Octokit.Model.MarketplaceCategory.Create);

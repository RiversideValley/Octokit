namespace Octokit.Model
{
    ...
    public class Status : QueryableValue<Status>
    {
        ...
        public StatusCheckRollupContextConnection CombinedContexts(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.CombinedContexts(first, after, last, before), Octokit.Model.StatusCheckRollupContextConnection.Create);
        ...
        public StatusContext Context(Arg<string> name) => this.CreateMethodCall(x => x.Context(name), Octokit.Model.StatusContext.Create);

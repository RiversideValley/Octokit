namespace Octokit.Model
{
    ...
    public class ProfileItemShowcase : QueryableValue<ProfileItemShowcase>
    {
        ...
        public PinnableItemConnection Items(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.Items(first, after, last, before), Octokit.Model.PinnableItemConnection.Create);

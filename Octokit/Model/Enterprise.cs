namespace Octokit.Model
{
    ...
    public class Enterprise : QueryableValue<Enterprise>
    {
        ...
        /// </summary>
        public EnterpriseBillingInfo BillingInfo => this.CreateProperty(x => x.BillingInfo, Octokit.Model.EnterpriseBillingInfo.Create);
        ...
        public OrganizationConnection Organizations(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<OrganizationOrder>? orderBy = null, Arg<string>? query = null, Arg<RoleInOrganization>? viewerOrganizationRole = null) => this.CreateMethodCall(x => x.Organizations(first, after, last, before, orderBy, query, viewerOrganizationRole), Octokit.Model.OrganizationConnection.Create);
        ...
        /// </summary>
        public EnterpriseOwnerInfo OwnerInfo => this.CreateProperty(x => x.OwnerInfo, Octokit.Model.EnterpriseOwnerInfo.Create);

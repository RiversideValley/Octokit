namespace Octokit.Model
{
    ...
    public class ProjectV2IterationField : QueryableValue<ProjectV2IterationField>
    {
        ...
        /// </summary>
        public ProjectV2IterationFieldConfiguration Configuration => this.CreateProperty(x => x.Configuration, Octokit.Model.ProjectV2IterationFieldConfiguration.Create);

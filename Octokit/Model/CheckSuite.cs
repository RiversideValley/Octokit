namespace Octokit.Model
{
    ...
    public class CheckSuite : QueryableValue<CheckSuite>
    {
        ...
        /// </summary>
        public App App => this.CreateProperty(x => x.App, Octokit.Model.App.Create);

        /// <summary>
        /// The name of the branch for this check suite.
        /// </summary>
        public Ref Branch => this.CreateProperty(x => x.Branch, Octokit.Model.Ref.Create);
        ...
        public CheckRunConnection CheckRuns(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<CheckRunFilter>? filterBy = null) => this.CreateMethodCall(x => x.CheckRuns(first, after, last, before, filterBy), Octokit.Model.CheckRunConnection.Create);
        ...
        /// </summary>
        public User Creator => this.CreateProperty(x => x.Creator, Octokit.Model.User.Create);
        ...
        /// </summary>
        public Push Push => this.CreateProperty(x => x.Push, Octokit.Model.Push.Create);
        ...
        /// </summary>
        public WorkflowRun WorkflowRun => this.CreateProperty(x => x.WorkflowRun, Octokit.Model.WorkflowRun.Create);

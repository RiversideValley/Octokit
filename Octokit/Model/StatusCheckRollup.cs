namespace Octokit.Model
{
    ...
    public class StatusCheckRollup : QueryableValue<StatusCheckRollup>
    {
        ...
        public StatusCheckRollupContextConnection Contexts(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.Contexts(first, after, last, before), Octokit.Model.StatusCheckRollupContextConnection.Create);

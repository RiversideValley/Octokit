namespace Octokit.Model
{
    ...
    public class EnterpriseOwnerInfo : QueryableValue<EnterpriseOwnerInfo>
    {
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public UserConnection AffiliatedUsersWithTwoFactorDisabled(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.AffiliatedUsersWithTwoFactorDisabled(first, after, last, before), Octokit.Model.UserConnection.Create);
        ...
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        /// <param name="query">The search string to look for.</param>
        public EnterpriseFailedInvitationConnection FailedInvitations(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<string>? query = null) => this.CreateMethodCall(x => x.FailedInvitations(first, after, last, before, query), Octokit.Model.EnterpriseFailedInvitationConnection.Create);
        ...
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        /// <param name="orderBy">Ordering options for organizations with this setting.</param>
        public OrganizationConnection MembersCanDeleteRepositoriesSettingOrganizations(Arg<bool> value, Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<OrganizationOrder>? orderBy = null) => this.CreateMethodCall(x => x.MembersCanDeleteRepositoriesSettingOrganizations(value, first, after, last, before, orderBy), Octokit.Model.OrganizationConnection.Create);
        ...
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        /// <param name="orderBy">Ordering options for organizations with this setting.</param>
        public OrganizationConnection MembersCanViewDependencyInsightsSettingOrganizations(Arg<bool> value, Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<OrganizationOrder>? orderBy = null) => this.CreateMethodCall(x => x.MembersCanViewDependencyInsightsSettingOrganizations(value, first, after, last, before, orderBy), Octokit.Model.OrganizationConnection.Create);
        ...
        /// </summary>
        public OIDCProvider OidcProvider => this.CreateProperty(x => x.OidcProvider, Octokit.Model.OIDCProvider.Create);
        ...
        public EnterpriseOutsideCollaboratorConnection OutsideCollaborators(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<bool>? hasTwoFactorEnabled = null, Arg<string>? login = null, Arg<EnterpriseMemberOrder>? orderBy = null, Arg<IEnumerable<string>>? organizationLogins = null, Arg<string>? query = null, Arg<RepositoryVisibility>? visibility = null) => this.CreateMethodCall(x => x.OutsideCollaborators(first, after, last, before, hasTwoFactorEnabled, login, orderBy, organizationLogins, query, visibility), Octokit.Model.EnterpriseOutsideCollaboratorConnection.Create);
        ...
        /// <param name="query">The search string to look for.</param>
        public EnterprisePendingMemberInvitationConnection PendingMemberInvitations(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<OrganizationInvitationSource>? invitationSource = null, Arg<IEnumerable<string>>? organizationLogins = null, Arg<string>? query = null) => this.CreateMethodCall(x => x.PendingMemberInvitations(first, after, last, before, invitationSource, organizationLogins, query), Octokit.Model.EnterprisePendingMemberInvitationConnection.Create);
        ...
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        /// <param name="orderBy">Ordering options for organizations with this setting.</param>
        public OrganizationConnection RepositoryProjectsSettingOrganizations(Arg<bool> value, Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<OrganizationOrder>? orderBy = null) => this.CreateMethodCall(x => x.RepositoryProjectsSettingOrganizations(value, first, after, last, before, orderBy), Octokit.Model.OrganizationConnection.Create);

        /// <summary>
        /// The SAML Identity Provider for the enterprise.
        /// </summary>
        public EnterpriseIdentityProvider SamlIdentityProvider => this.CreateProperty(x => x.SamlIdentityProvider, Octokit.Model.EnterpriseIdentityProvider.Create);
        ...
        public EnterpriseMemberConnection SupportEntitlements(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<EnterpriseMemberOrder>? orderBy = null) => this.CreateMethodCall(x => x.SupportEntitlements(first, after, last, before, orderBy), Octokit.Model.EnterpriseMemberConnection.Create);
        ...
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        /// <param name="orderBy">Ordering options for organizations with this setting.</param>
        public OrganizationConnection TwoFactorRequiredSettingOrganizations(Arg<bool> value, Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<OrganizationOrder>? orderBy = null) => this.CreateMethodCall(x => x.TwoFactorRequiredSettingOrganizations(value, first, after, last, before, orderBy), Octokit.Model.OrganizationConnection.Create);

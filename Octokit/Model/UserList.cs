namespace Octokit.Model
{
    ...
    public class UserList : QueryableValue<UserList>
    {
        ...
        public UserListItemsConnection Items(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.Items(first, after, last, before), Octokit.Model.UserListItemsConnection.Create);

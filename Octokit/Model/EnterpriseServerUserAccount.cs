namespace Octokit.Model
{
    ...
    public class EnterpriseServerUserAccount : QueryableValue<EnterpriseServerUserAccount>
    {
        ...
        public EnterpriseServerUserAccountEmailConnection Emails(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<EnterpriseServerUserAccountEmailOrder>? orderBy = null) => this.CreateMethodCall(x => x.Emails(first, after, last, before, orderBy), Octokit.Model.EnterpriseServerUserAccountEmailConnection.Create);

        /// <summary>
        /// The Enterprise Server installation on which this user account exists.
        /// </summary>
        public EnterpriseServerInstallation EnterpriseServerInstallation => this.CreateProperty(x => x.EnterpriseServerInstallation, Octokit.Model.EnterpriseServerInstallation.Create);

namespace Octokit.Model
{
    ...
    public class SponsorsTier : QueryableValue<SponsorsTier>
    {
        ...
        /// </summary>
        public SponsorsTierAdminInfo AdminInfo => this.CreateProperty(x => x.AdminInfo, Octokit.Model.SponsorsTierAdminInfo.Create);
        ...
        /// </summary>
        public SponsorsTier ClosestLesserValueTier => this.CreateProperty(x => x.ClosestLesserValueTier, Octokit.Model.SponsorsTier.Create);

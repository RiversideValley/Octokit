namespace Octokit.Model
{
    ...
    public class PullRequestReview : QueryableValue<PullRequestReview>
    {
        ...
        public PullRequestReviewCommentConnection Comments(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.Comments(first, after, last, before), Octokit.Model.PullRequestReviewCommentConnection.Create);
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public TeamConnection OnBehalfOf(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.OnBehalfOf(first, after, last, before), Octokit.Model.TeamConnection.Create);

namespace Octokit.Model
{
    ...
    public class PullRequestContributionsByRepository : QueryableValue<PullRequestContributionsByRepository>
    {
        ...
        public CreatedPullRequestContributionConnection Contributions(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<ContributionOrder>? orderBy = null) => this.CreateMethodCall(x => x.Contributions(first, after, last, before, orderBy), Octokit.Model.CreatedPullRequestContributionConnection.Create);

namespace Octokit.Model
{
    ...
    public class Organization : QueryableValue<Organization>
    {
        ...
        public OrganizationAuditEntryConnection AuditLog(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<AuditLogOrder>? orderBy = null, Arg<string>? query = null) => this.CreateMethodCall(x => x.AuditLog(first, after, last, before, orderBy, query), Octokit.Model.OrganizationAuditEntryConnection.Create);
        ...
        public OrganizationEnterpriseOwnerConnection EnterpriseOwners(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<OrgEnterpriseOwnerOrder>? orderBy = null, Arg<RoleInOrganization>? organizationRole = null, Arg<string>? query = null) => this.CreateMethodCall(x => x.EnterpriseOwners(first, after, last, before, orderBy, organizationRole, query), Octokit.Model.OrganizationEnterpriseOwnerConnection.Create);
        ...
        public IpAllowListEntryConnection IpAllowListEntries(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<IpAllowListEntryOrder>? orderBy = null) => this.CreateMethodCall(x => x.IpAllowListEntries(first, after, last, before, orderBy), Octokit.Model.IpAllowListEntryConnection.Create);
        ...
        public MannequinConnection Mannequins(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<string>? login = null, Arg<MannequinOrder>? orderBy = null) => this.CreateMethodCall(x => x.Mannequins(first, after, last, before, login, orderBy), Octokit.Model.MannequinConnection.Create);
        ...
        public UserStatusConnection MemberStatuses(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<UserStatusOrder>? orderBy = null) => this.CreateMethodCall(x => x.MemberStatuses(first, after, last, before, orderBy), Octokit.Model.UserStatusConnection.Create);
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public OrganizationMemberConnection MembersWithRole(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.MembersWithRole(first, after, last, before), Octokit.Model.OrganizationMemberConnection.Create);
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public UserConnection PendingMembers(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.PendingMembers(first, after, last, before), Octokit.Model.UserConnection.Create);
        ...
        public RepositoryRuleset Ruleset(Arg<int> databaseId) => this.CreateMethodCall(x => x.Ruleset(databaseId), Octokit.Model.RepositoryRuleset.Create);
        ...
        /// </summary>
        public OrganizationIdentityProvider SamlIdentityProvider => this.CreateProperty(x => x.SamlIdentityProvider, Octokit.Model.OrganizationIdentityProvider.Create);
        ...
        public Team Team(Arg<string> slug) => this.CreateMethodCall(x => x.Team(slug), Octokit.Model.Team.Create);

namespace Octokit.Model
{
    ...
    public class Repository : QueryableValue<Repository>
    {
        ...
        public UserConnection AssignableUsers(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<string>? query = null) => this.CreateMethodCall(x => x.AssignableUsers(first, after, last, before, query), Octokit.Model.UserConnection.Create);
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public BranchProtectionRuleConnection BranchProtectionRules(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.BranchProtectionRules(first, after, last, before), Octokit.Model.BranchProtectionRuleConnection.Create);

        /// <summary>
        /// Returns the code of conduct for this repository
        /// </summary>
        public CodeOfConduct CodeOfConduct => this.CreateProperty(x => x.CodeOfConduct, Octokit.Model.CodeOfConduct.Create);

        /// <summary>
        /// Information extracted from the repository's `CODEOWNERS` file.
        /// </summary>
        /// <param name="refName">The ref name used to return the associated `CODEOWNERS` file.</param>
        public RepositoryCodeowners Codeowners(Arg<string>? refName = null) => this.CreateMethodCall(x => x.Codeowners(refName), Octokit.Model.RepositoryCodeowners.Create);
        ...
        /// <param name="query">Filters users with query on user name and login</param>
        public RepositoryCollaboratorConnection Collaborators(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<CollaboratorAffiliation>? affiliation = null, Arg<string>? login = null, Arg<string>? query = null) => this.CreateMethodCall(x => x.Collaborators(first, after, last, before, affiliation, login, query), Octokit.Model.RepositoryCollaboratorConnection.Create);
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public CommitCommentConnection CommitComments(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.CommitComments(first, after, last, before), Octokit.Model.CommitCommentConnection.Create);
        ...
        /// </summary>
        public ContributingGuidelines ContributingGuidelines => this.CreateProperty(x => x.ContributingGuidelines, Octokit.Model.ContributingGuidelines.Create);
        ...
        /// </summary>
        public Ref DefaultBranchRef => this.CreateProperty(x => x.DefaultBranchRef, Octokit.Model.Ref.Create);
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public DeployKeyConnection DeployKeys(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.DeployKeys(first, after, last, before), Octokit.Model.DeployKeyConnection.Create);
        ...
        public DeploymentConnection Deployments(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<IEnumerable<string>>? environments = null, Arg<DeploymentOrder>? orderBy = null) => this.CreateMethodCall(x => x.Deployments(first, after, last, before, environments, orderBy), Octokit.Model.DeploymentConnection.Create);
        ...
        public Discussion Discussion(Arg<int> number) => this.CreateMethodCall(x => x.Discussion(number), Octokit.Model.Discussion.Create);
        ...
        public DiscussionConnection Discussions(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<bool>? answered = null, Arg<ID>? categoryId = null, Arg<DiscussionOrder>? orderBy = null, Arg<IEnumerable<DiscussionState>>? states = null) => this.CreateMethodCall(x => x.Discussions(first, after, last, before, answered, categoryId, orderBy, states), Octokit.Model.DiscussionConnection.Create);
        ...
        public Environment Environment(Arg<string> name) => this.CreateMethodCall(x => x.Environment(name), Octokit.Model.Environment.Create);
        ...
        public EnvironmentConnection Environments(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<IEnumerable<string>>? names = null, Arg<Environments>? orderBy = null) => this.CreateMethodCall(x => x.Environments(first, after, last, before, names, orderBy), Octokit.Model.EnvironmentConnection.Create);
        ...
        /// </summary>
        public RepositoryInteractionAbility InteractionAbility => this.CreateProperty(x => x.InteractionAbility, Octokit.Model.RepositoryInteractionAbility.Create);
        ...
        public Issue Issue(Arg<int> number) => this.CreateMethodCall(x => x.Issue(number), Octokit.Model.Issue.Create);

        /// <summary>
        /// Returns a single issue-like object from the current repository by number.
        /// </summary>
        /// <param name="number">The number for the issue to be returned.</param>
        public IssueOrPullRequest IssueOrPullRequest(Arg<int> number) => this.CreateMethodCall(x => x.IssueOrPullRequest(number), Octokit.Model.IssueOrPullRequest.Create);
        ...
        public LabelConnection Labels(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<LabelOrder>? orderBy = null, Arg<string>? query = null) => this.CreateMethodCall(x => x.Labels(first, after, last, before, orderBy, query), Octokit.Model.LabelConnection.Create);
        ...
        public LanguageConnection Languages(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<LanguageOrder>? orderBy = null) => this.CreateMethodCall(x => x.Languages(first, after, last, before, orderBy), Octokit.Model.LanguageConnection.Create);

        /// <summary>
        /// Get the latest release for the repository if one exists.
        /// </summary>
        public Release LatestRelease => this.CreateProperty(x => x.LatestRelease, Octokit.Model.Release.Create);

        /// <summary>
        /// The license associated with the repository
        /// </summary>
        public License LicenseInfo => this.CreateProperty(x => x.LicenseInfo, Octokit.Model.License.Create);
        ...
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        /// <param name="query">Filters users with query on user name and login</param>
        public UserConnection MentionableUsers(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<string>? query = null) => this.CreateMethodCall(x => x.MentionableUsers(first, after, last, before, query), Octokit.Model.UserConnection.Create);
        ...
        public MergeQueue MergeQueue(Arg<string>? branch = null) => this.CreateMethodCall(x => x.MergeQueue(branch), Octokit.Model.MergeQueue.Create);

        /// <summary>
        /// Returns a single milestone from the current repository by number.
        /// </summary>
        /// <param name="number">The number for the milestone to be returned.</param>
        public Milestone Milestone(Arg<int> number) => this.CreateMethodCall(x => x.Milestone(number), Octokit.Model.Milestone.Create);
        ...
        public MilestoneConnection Milestones(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<MilestoneOrder>? orderBy = null, Arg<string>? query = null, Arg<IEnumerable<MilestoneState>>? states = null) => this.CreateMethodCall(x => x.Milestones(first, after, last, before, orderBy, query, states), Octokit.Model.MilestoneConnection.Create);
        ...
        public IGitObject Object(Arg<string>? expression = null, Arg<string>? oid = null) => this.CreateMethodCall(x => x.Object(expression, oid), Octokit.Model.Internal.StubIGitObject.Create);
        ...
        /// </summary>
        public IRepositoryOwner Owner => this.CreateProperty(x => x.Owner, Octokit.Model.Internal.StubIRepositoryOwner.Create);
        ...
        public PackageConnection Packages(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<IEnumerable<string>>? names = null, Arg<PackageOrder>? orderBy = null, Arg<PackageType>? packageType = null, Arg<ID>? repositoryId = null) => this.CreateMethodCall(x => x.Packages(first, after, last, before, names, orderBy, packageType, repositoryId), Octokit.Model.PackageConnection.Create);

        /// <summary>
        /// The repository parent, if this is a fork.
        /// </summary>
        public Repository Parent => this.CreateProperty(x => x.Parent, Octokit.Model.Repository.Create);
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public PinnedDiscussionConnection PinnedDiscussions(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.PinnedDiscussions(first, after, last, before), Octokit.Model.PinnedDiscussionConnection.Create);
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public PinnedIssueConnection PinnedIssues(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.PinnedIssues(first, after, last, before), Octokit.Model.PinnedIssueConnection.Create);

        /// <summary>
        /// Returns information about the availability of certain features and limits based on the repository's billing plan.
        /// </summary>
        public RepositoryPlanFeatures PlanFeatures => this.CreateProperty(x => x.PlanFeatures, Octokit.Model.RepositoryPlanFeatures.Create);

        /// <summary>
        /// The primary language of the repository's code.
        /// </summary>
        public Language PrimaryLanguage => this.CreateProperty(x => x.PrimaryLanguage, Octokit.Model.Language.Create);

        /// <summary>
        /// Find project by number.
        /// </summary>
        /// <param name="number">The project number to find.</param>
        public Project Project(Arg<int> number) => this.CreateMethodCall(x => x.Project(number), Octokit.Model.Project.Create);

        /// <summary>
        /// Finds and returns the Project according to the provided Project number.
        /// </summary>
        /// <param name="number">The Project number.</param>
        public ProjectV2 ProjectV2(Arg<int> number) => this.CreateMethodCall(x => x.ProjectV2(number), Octokit.Model.ProjectV2.Create);
        ...
        public ProjectConnection Projects(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<ProjectOrder>? orderBy = null, Arg<string>? search = null, Arg<IEnumerable<ProjectState>>? states = null) => this.CreateMethodCall(x => x.Projects(first, after, last, before, orderBy, search, states), Octokit.Model.ProjectConnection.Create);
        ...
        public ProjectV2Connection ProjectsV2(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<ProjectV2Order>? orderBy = null, Arg<string>? query = null) => this.CreateMethodCall(x => x.ProjectsV2(first, after, last, before, orderBy, query), Octokit.Model.ProjectV2Connection.Create);

        /// <summary>
        /// Returns a single pull request from the current repository by number.
        /// </summary>
        /// <param name="number">The number for the pull request to be returned.</param>
        public PullRequest PullRequest(Arg<int> number) => this.CreateMethodCall(x => x.PullRequest(number), Octokit.Model.PullRequest.Create);
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public ProjectV2Connection RecentProjects(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.RecentProjects(first, after, last, before), Octokit.Model.ProjectV2Connection.Create);
        ...
        public Ref Ref(Arg<string> qualifiedName) => this.CreateMethodCall(x => x.Ref(qualifiedName), Octokit.Model.Ref.Create);
        ...
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        /// <param name="orderBy">Order for connection</param>
        public ReleaseConnection Releases(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<ReleaseOrder>? orderBy = null) => this.CreateMethodCall(x => x.Releases(first, after, last, before, orderBy), Octokit.Model.ReleaseConnection.Create);
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public RepositoryTopicConnection RepositoryTopics(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.RepositoryTopics(first, after, last, before), Octokit.Model.RepositoryTopicConnection.Create);
        ...
        public RepositoryRuleset Ruleset(Arg<int> databaseId, Arg<bool>? includeParents = null) => this.CreateMethodCall(x => x.Ruleset(databaseId, includeParents), Octokit.Model.RepositoryRuleset.Create);
        ...
        public RepositoryRulesetConnection Rulesets(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<bool>? includeParents = null) => this.CreateMethodCall(x => x.Rulesets(first, after, last, before, includeParents), Octokit.Model.RepositoryRulesetConnection.Create);
        ...
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        /// <param name="orderBy">Order for connection</param>
        public StargazerConnection Stargazers(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<StarOrder>? orderBy = null) => this.CreateMethodCall(x => x.Stargazers(first, after, last, before, orderBy), Octokit.Model.StargazerConnection.Create);
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public SubmoduleConnection Submodules(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.Submodules(first, after, last, before), Octokit.Model.SubmoduleConnection.Create);
        ...
        /// </summary>
        public Repository TemplateRepository => this.CreateProperty(x => x.TemplateRepository, Octokit.Model.Repository.Create);
        ...
        public RepositoryVulnerabilityAlert VulnerabilityAlert(Arg<int> number) => this.CreateMethodCall(x => x.VulnerabilityAlert(number), Octokit.Model.RepositoryVulnerabilityAlert.Create);
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
        public UserConnection Watchers(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.Watchers(first, after, last, before), Octokit.Model.UserConnection.Create);

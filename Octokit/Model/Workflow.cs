namespace Octokit.Model
{
    ...
    public class Workflow : QueryableValue<Workflow>
    {
        ...
        public WorkflowRunConnection Runs(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<WorkflowRunOrder>? orderBy = null) => this.CreateMethodCall(x => x.Runs(first, after, last, before, orderBy), Octokit.Model.WorkflowRunConnection.Create);

namespace Octokit.Model
{
    ...
    public class TreeEntry : QueryableValue<TreeEntry>
    {
        ...
        /// </summary>
        public Language Language => this.CreateProperty(x => x.Language, Octokit.Model.Language.Create);
        ...
        /// Entry file object.
        /// </summary>
        public IGitObject Object => this.CreateProperty(x => x.Object, Octokit.Model.Internal.StubIGitObject.Create);
        ...
        /// </summary>
        public Submodule Submodule => this.CreateProperty(x => x.Submodule, Octokit.Model.Submodule.Create);

namespace Octokit.Model
{
    ...
    public class DeploymentReview : QueryableValue<DeploymentReview>
    {
        ...
        public EnvironmentConnection Environments(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.Environments(first, after, last, before), Octokit.Model.EnvironmentConnection.Create);

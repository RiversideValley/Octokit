namespace Octokit.Model
{
    ...
    public class MergeQueue : QueryableValue<MergeQueue>
    {
        ...
        /// </summary>
        public MergeQueueConfiguration Configuration => this.CreateProperty(x => x.Configuration, Octokit.Model.MergeQueueConfiguration.Create);
        ...
        public MergeQueueEntryConnection Entries(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.Entries(first, after, last, before), Octokit.Model.MergeQueueEntryConnection.Create);

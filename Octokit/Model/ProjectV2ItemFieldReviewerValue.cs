namespace Octokit.Model
{
    ...
    public class ProjectV2ItemFieldReviewerValue : QueryableValue<ProjectV2ItemFieldReviewerValue>
    {
        ...
        public RequestedReviewerConnection Reviewers(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.Reviewers(first, after, last, before), Octokit.Model.RequestedReviewerConnection.Create);

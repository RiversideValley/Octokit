namespace Octokit.Model
{
    ...
    public class MarkedAsDuplicateEvent : QueryableValue<MarkedAsDuplicateEvent>
    {
        ...
        /// </summary>
        public IssueOrPullRequest Canonical => this.CreateProperty(x => x.Canonical, Octokit.Model.IssueOrPullRequest.Create);
        ...
        /// </summary>
        public IssueOrPullRequest Duplicate => this.CreateProperty(x => x.Duplicate, Octokit.Model.IssueOrPullRequest.Create);

namespace Octokit.Model
{
    ...
    public class PullRequestReviewThread : QueryableValue<PullRequestReviewThread>
    {
        ...
        public PullRequestReviewCommentConnection Comments(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<int>? skip = null) => this.CreateMethodCall(x => x.Comments(first, after, last, before, skip), Octokit.Model.PullRequestReviewCommentConnection.Create);
        ...
        /// </summary>
        public User ResolvedBy => this.CreateProperty(x => x.ResolvedBy, Octokit.Model.User.Create);

namespace Octokit.Model
{
    ...
    public class Deployment : QueryableValue<Deployment>
    {
        ...
        /// </summary>
        public DeploymentStatus LatestStatus => this.CreateProperty(x => x.LatestStatus, Octokit.Model.DeploymentStatus.Create);
        ...
        public DeploymentStatusConnection Statuses(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.Statuses(first, after, last, before), Octokit.Model.DeploymentStatusConnection.Create);

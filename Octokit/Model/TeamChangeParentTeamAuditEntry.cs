namespace Octokit.Model
{
    ...
    public class TeamChangeParentTeamAuditEntry : QueryableValue<TeamChangeParentTeamAuditEntry>
    {
        ...
        /// </summary>
        public AuditEntryActor Actor => this.CreateProperty(x => x.Actor, Octokit.Model.AuditEntryActor.Create);
        ...
        /// </summary>
        public ActorLocation ActorLocation => this.CreateProperty(x => x.ActorLocation, Octokit.Model.ActorLocation.Create);
        ...
        /// </summary>
        public Team ParentTeamWas => this.CreateProperty(x => x.ParentTeamWas, Octokit.Model.Team.Create);

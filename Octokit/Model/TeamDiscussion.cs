namespace Octokit.Model
{
    ...
    public class TeamDiscussion : QueryableValue<TeamDiscussion>
    {
        ...
        public TeamDiscussionCommentConnection Comments(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<int>? fromComment = null, Arg<TeamDiscussionCommentOrder>? orderBy = null) => this.CreateMethodCall(x => x.Comments(first, after, last, before, fromComment, orderBy), Octokit.Model.TeamDiscussionCommentConnection.Create);

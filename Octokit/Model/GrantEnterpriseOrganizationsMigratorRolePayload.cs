namespace Octokit.Model
{
    ...
    public class GrantEnterpriseOrganizationsMigratorRolePayload : QueryableValue<GrantEnterpriseOrganizationsMigratorRolePayload>
    {
        ...
        public OrganizationConnection Organizations(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.Organizations(first, after, last, before), Octokit.Model.OrganizationConnection.Create);

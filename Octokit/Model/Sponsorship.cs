namespace Octokit.Model
{
    ...
    public class Sponsorship : QueryableValue<Sponsorship>
    {
        ...
        public User Maintainer => this.CreateProperty(x => x.Maintainer, Octokit.Model.User.Create);
        ...
        public User Sponsor => this.CreateProperty(x => x.Sponsor, Octokit.Model.User.Create);

        /// <summary>
        /// The user or organization that is sponsoring, if you have permission to view them.
        /// </summary>
        public Sponsor SponsorEntity => this.CreateProperty(x => x.SponsorEntity, Octokit.Model.Sponsor.Create);
        ...
        /// </summary>
        public SponsorsTier Tier => this.CreateProperty(x => x.Tier, Octokit.Model.SponsorsTier.Create);

namespace Octokit.Model
{
    ...
    public class SecurityAdvisory : QueryableValue<SecurityAdvisory>
    {
        ...
        /// </summary>
        public CVSS Cvss => this.CreateProperty(x => x.Cvss, Octokit.Model.CVSS.Create);
        ...
        public CWEConnection Cwes(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null) => this.CreateMethodCall(x => x.Cwes(first, after, last, before), Octokit.Model.CWEConnection.Create);

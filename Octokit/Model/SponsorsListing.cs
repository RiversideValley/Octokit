namespace Octokit.Model
{
    ...
    public class SponsorsListing : QueryableValue<SponsorsListing>
    {
        ...
        /// </summary>
        public SponsorsGoal ActiveGoal => this.CreateProperty(x => x.ActiveGoal, Octokit.Model.SponsorsGoal.Create);
        ...
        /// </summary>
        public StripeConnectAccount ActiveStripeConnectAccount => this.CreateProperty(x => x.ActiveStripeConnectAccount, Octokit.Model.StripeConnectAccount.Create);
        ...
        /// </summary>
        public Organization FiscalHost => this.CreateProperty(x => x.FiscalHost, Octokit.Model.Organization.Create);

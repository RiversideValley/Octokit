namespace Octokit.Model
{
    ...
    public class OrganizationsHovercardContext : QueryableValue<OrganizationsHovercardContext>
    {
        ...
        public OrganizationConnection RelevantOrganizations(Arg<int>? first = null, Arg<string>? after = null, Arg<int>? last = null, Arg<string>? before = null, Arg<OrganizationOrder>? orderBy = null) => this.CreateMethodCall(x => x.RelevantOrganizations(first, after, last, before, orderBy), Octokit.Model.OrganizationConnection.Create);
